...
>
> - [x] Define hash functions and their properties
> - [x] Compare different hash algorithms
> - [x] Explain hash function applications
...
MD5 was once a popular choice with a 128-bit hash value. However, since it was proven to not be resistant to collisions in 2004, it is no longer recommended. [^1]
...
SHA-2, the successor to these, uses a different algorithm and includes hash functions SHA-224, SHA-256, SHA-384, and SHA-512. To date, there have been no successful attacks reported on any of the SHA-2 hash functions. [^2]
...
[^1]  Ciampa, M., “CompTIA Security+ 2008 in depth”. Course Technology PTR, 2009.
[^2] Penard, W., and Van Werkhoven, T. "On the secure hash algorithm family." Cryptography in context, pp. 1-18, 2008.
