...
1. What is the purpose of integrated shrinking in Aiken's property-based testing?

A) To generate random test cases
**B) To simplify failing test cases to identify the core issue**
C) To check for specific output values
D) To replace unit tests

2. What does a Fuzzer do in Aiken's property-based testing?

A) Checks for specific output values
B) Defines properties to be tested
**C) Generates random values for testing**
D) Simplifies failing test cases

3. Which keyword is used to create fuzzers in Aiken? 
...
4. What command is used to run property-based tests in Aiken?
...
5. What does Aiken's property-based testing framework primarily focus on?

A) Specific test cases with pre-computed outputs
B) Manual test case generation
C) Code optimization
**D) Behaviour patterns across a range of inputs**
