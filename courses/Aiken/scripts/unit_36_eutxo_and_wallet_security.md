# eUTxO and Wallet Security

The underlying architecture and account model affects how basic tools and services are built. CIP 30 Cardano dApp Wallet Web Bridge led to a standard approach for building wallets on Cardano. There are over a dozen options to choose from on the Developer Portal Showcase section. Wallets are arguably more secure due to the UTxO model. 
