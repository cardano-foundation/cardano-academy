...
1. Which keyword is used to promote functions to validator handlers in Aiken?
...
2. How many handler types are available in Aiken validators?
...
3. What does the let keyword do in Aiken? 

A) Defines a variable
B) Creates a loop
C) Destructures an element with an unknown shape
**D) Destructures an element with a known shape**

4. When should you use the expect keyword in Aiken?

A) When the shape of the element is known at compile time
**B) When the shape of the element is unknown at compile time**
C) When you want to define a function
D) When you want to create a validator

5. What do Aiken handlers return when evaluated?
