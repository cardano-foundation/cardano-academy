# ZK Roll Ups on Ethereum

Zero-Knowledge Rollups, or ZK Rollups, are a powerful scaling solution that can enhance the performance of DApps. By moving complex computations off-chain, ZK Rollups enable them to be executed much faster and consume fewer resources. It’s a little like a restaurant with a side kitchen where the sous-chef prepares fancier dishes and relieves the burden on the main kitchen. If you need a refresher on Layer 2 solutions, revisit CBCA Module 2 Unit 7.
...
1. What is the main challenge with account-based ledgers?
...
2. What is a sequencer in the context of Ethereum ZK Rollups?

A. A decentralized entity that validates transactions
B. A smart contract that manages user balances
**C. A centralized entity that reorders transactions**
D. A cryptographic proof that ensures transaction validity

3. What is the primary benefit of using Zero-Knowledge Rollups (ZK Rollups) as a scaling solution?

A. They eliminate the need for transaction fees
B. They increase the security of the blockchain
C. They allow for the creation of private transactions
**D. They enhance the performance of DApps by moving computations off-chain**
