...
Sharding is a term that should be familiar to anyone from the Web2 database world. It involves slicing a database into smaller pieces, or shards. The result is that the database is “more than the sum of its parts.” The aggregate performance of the shards is greater than before.
...
What is the primary unit of validation in the Cardano blockchain?
