...
1. Which of the following is NOT a primitive type in Aiken?
...
2. What is the main purpose of the Data type in Aiken?

A. To represent strings of characters
B. To store collections of values of the exact same type
C. To define functions with specific inputs and outputs
**D. To act as a wildcard that can represent any serializable value**

3. How are variables declared in Aiken?

A. Using var keyword
B. Using const keyword
**C. Using let bindings**
D. Using define keyword

4. What is the primary way to implement loops in Aiken?
