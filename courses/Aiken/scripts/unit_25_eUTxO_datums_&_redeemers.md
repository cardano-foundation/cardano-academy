...
1. What is the context provided to a script during validation?
A) The current state of the entire blockchain
B) The history of all previous transactions
**C) The transaction being validated, including its inputs and outputs**
D) The global set of unspent transaction outputs
